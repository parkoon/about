    ...
    features: [
      {
        ...
        achievements: [
          ...
          "실험실(Lab) 문화 제안 및 운영으로 빠른 검증 체계 구축",
          "15+ 리워드 게임 런칭 및 다양한 수익 모델 실험",
        ],
        contributions: [
          "보상-참여-리텐션 패턴 분석 → 반복 패턴 발견으로 신규 피처 개발 시간 대폭 단축",
          "실험실 운영 도입 → 디자인 완성도보다 사용자 반응 우선, 3개월 만에 3개 피처 정식 출시",
          "웹뷰 QA SDK 개발 → 캡처-드로잉-지라/슬랙 자동 연동으로 1명의 QA로도 원활한 운영 가능",
          "프로토타입 기반 커뮤니케이션 도입 → 실제 동작하는 프로토타입으로 의사결정 속도 향상",
          "기획/백엔드 설계 초기 참여 → 단순한 구조 제안으로 개발 복잡도 감소 및 확장성 확보",
          "외부 파트너사 CPA 연동 → 쿠팡, 보험사 등 제휴 광고 수익 모델 통합",
        ],
        spec: [
          "TypeScript",
          "React.js",
      ...
      },
      {
        ...
        contributions: [
          "Next.js 13 App Router 초기 도입 성공 → 초기 로딩 속도 개선, SEO 최적화",
      ...
      },
      {
        ...
        contributions: [
          ...
          "타사 B2B 서비스 (샵플링, 세틀뱅크 등) 벤치마킹을 통한 빠른 UI/UX 설계 → 일관된 B2B 서비스 구축",
          "전자계약 시스템 구축 → 파트너사별 계약서 템플릿 관리, 전자 서명, 도장 이미지 동적 삽입, PDF 암호화로 법적 효력 있는 계약서 자동 생성",
        ],
        spec: [
          "TypeScript",
          "React.js",
    ...
    features: [
      {
        ...
        contributions: [
          ...
          "Optimistic UI 패턴 도입 → 인도네시아 네트워크 환경에서도 원활한 사용자 경험 제공",
    ...
    features: [
      {
        ...
        contributions: [
          "타입 세이프 API 레이어 구축 → Swagger 기반 자동 타이핑으로 개발 효율성 향상",
          "Optimistic Updates 패턴 도입 → 즉각적인 UI 반응으로 사용자 경험 향상",
      ...
      },
      {
        ...
        contributions: [
          "Webpack 기반 V1에서 Next.js 기반 V2로 전면 재구축 → 빌드 설정 간소화, 개발 환경 안정화",
          "어드민 UI 표준화 → 일관된 UX 제공, 신규 입점사 온보딩 시간 단축",
      ...
      },
      {
        ...
        contributions: [
          ...
          "Deploy Webhook 자동화 → 콘텐츠 변경 시 자동 빌드/배포로 운영 효율성 극대화",
        ],
        spec: [
          "TypeScript",
          "React.js",
